...
import { getEmployers, createEmployer, updateEmployer, deleteEmployer } from '../controllers/employerController.js';
...
router.put('/:id', requireRole('USER', 'DBA'), updateEmployer);
